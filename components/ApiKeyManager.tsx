                                ...
                                {!apiKey.isDefault && (
                                    <div className="flex items-center flex-shrink-0 ml-2">
                                        <div className="w-6 h-6 flex items-center justify-center mr-1">
                                            ...
                                            {testStatus[apiKey.id] === 'success' && <CheckCircleIcon className="w-5 h-5 text-green-400" title="Test successful!" />}
                                            {testStatus[apiKey.id] === 'error' && <ExclamationCircleIcon className="w-5 h-5 text-red-400" title={testError[apiKey.id] || 'Test failed!'} />}
                                        </div>
