...
export const StoryManager: React.FC<StoryManagerProps> = ({
  ...
  const sortedStories = (Object.values(stories) as Story[]).sort(
          ...
          <ul className="space-y-2">
            {sortedStories.length > 0 ? (
              sortedStories.map((story) => (
                <li
                  key={story.id}
                  className={`p-3 rounded-md flex justify-between items-center ${story.id === activeStoryId ? 'bg-primary/20 border border-primary/50' : 'bg-muted/50'}`}
                >
                  <div className="overflow-hidden">
                    {editingStoryId === story.id ? (
                      ...
                      <p className="font-semibold truncate text-foreground" title={story.name}>
                        {story.name}
                      </p>
                    )}
                  ...
                  <div className="flex flex-shrink-0 ml-2">
                    {editingStoryId === story.id ? (
                      <button
                        ...
                        className="p-2 rounded-full hover:bg-muted text-green-500"
                        title="Save"
                      >
                      ...
                      <>
                        <button
                          ...
                          disabled={story.id === activeStoryId}
                        ...
                        >
                          ...
                          >
                            <path
                              fillRule="evenodd"
                              d="M4 2a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2V4a2 2 0 00-2-2H4zm11 5a1 1 0 10-2 0v2a1 1 0 102 0V7zM7 7a1 1 0 011-1h2a1 1 0 110 2H8a1 1 0 01-1-1zm-3 4a1 1 0 100 2h8a1 1 0 100-2H4z"
                              clipRule="evenodd"
                            />
                          </svg>
                        </button>
