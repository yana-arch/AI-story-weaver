        ...
        {profiles.length > 0 ? (
          profiles.map((profile) => (
            <div key={profile.id} className="bg-muted/50 p-3 rounded-lg border border-border group">
              ...
              <div className="space-y-2 text-sm text-muted-foreground">
                {profile.personality && (
                  <p>
                    <strong className="text-muted-foreground">Personality:</strong>{' '}
                    {profile.personality}
                  </p>
                )}
                {profile.appearance && (
                  <p>
                    <strong className="text-muted-foreground">Appearance:</strong>{' '}
                    {profile.appearance}
                  </p>
                )}
                {profile.goals && (
                  <p>
                    <strong className="text-muted-foreground">Goals:</strong> {profile.goals}
                  </p>
                )}
              </div>
            </div>
          ...
          <div className="text-center text-muted-foreground py-10">
            ...
            <p className="mt-2 text-xs">
              Use the button below to let AI analyze your story and create them.
            </p>
          </div>
        )}
      </div>
